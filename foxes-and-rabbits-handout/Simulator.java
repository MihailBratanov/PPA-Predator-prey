...
public class Simulator
{
    ...
    private static final double BADGER_CREATION_PROBABILITY = 0.08; 
        // The probability that a rabbit will be created in any given grid position.
    private static final double SQUIRREL_CREATION_PROBABILITY = 0.05; 
    
        // The probability that a rabbit will be created in any given grid position.
    private static final double HEDGEHOG_CREATION_PROBABILITY = 0.10; 
    ...
    public Simulator(int depth, int width)
    {
        ...
        view.setColor(Squirrel.class,Color.RED);
           view.setColor(Hedgehog.class,Color.GREEN);
